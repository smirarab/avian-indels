...
################# Run ASTRAL
java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i intron-indel-genetrees.tre -o intron-nt-astraltree.tre 2> intron-indel-astraltree.log &
for c in 0 3 5 10 20 33; do 
	java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i intron-indel-genetrees-$c-contract.tre -o intron-indel-astraltree-$c-contract.tre 2> intron-indel-astraltree-$c-contract.log &
done

java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i intron-nt-genetrees.tre -o intron-nt-astraltree.tre 2> intron-nt-astraltree.log &
for c in 0 3 5 10 20 33; do 
	java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i intron-nt-genetrees-$c-contract.tre -o intron-nt-astraltree-$c-contract.tre 2> intron-nt-astraltree-$c-contract.log &
done

java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i uce-indel-genetrees.tre -o uce-indel-astraltree.tre 2> uce-indel-astraltree.log &
for c in 0 3 5 10 20 33; do 
	java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i uce-indel-genetrees-$c-contract.tre -o uce-indel-astraltree-$c-contract.tre 2> uce-indel-astraltree-$c-contract.log &
done


for c in 0 3 5 10 20 33; do
	java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i intron-combined-genetrees-$c-contract.tre -o intron-combined--astraltree-$c-contract.tre 2> intron-combined--astraltree-$c-contract.log & 
done

java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i uce-combined-genetrees.tre -o uce-combined-astraltree.tre -w2 2> uce-combined-astraltree.log &
java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i uce-combined-genetrees-5-contract.tre -o uce-combined-astraltree-5-contract.tre -w2 2> uce-combined-astraltree-5-contract.log
java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i combined-combined-genetrees-5-contract.tre -o combined-combined-asltraltree-5-contract.tre -w2 2> combined-combined-asltraltree-5-contract.log & 

################# score for polytomies
for d in introng-indel/intron-indel intron-nt/intron-nt uce-indel/uce-indel uce-nt/uce-nt; do 
	for c in 0 3 5 10 20 33; do 
		java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i $d-genetrees-$c-contract.tre -q $d-astraltree-$c-contract.tre -t10  -o $d-astraltree-$c-contract-polytometest.tre 2> $d-astraltree-$c-contract-polytometest.log &
	done;
	java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i $d-genetrees.tre -q $d-astraltree.tre -o $d-astraltree-polytometest.tre -t10 2> $d-astraltree.polytometest.log &
done

for d in intron-indel/intron-indel intron-nt/intron-nt uce-indel/uce-indel uce-nt/uce-nt; do 
	for c in 0 3 5 10 20 33; do 
		java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i $d-genetrees-$c-contract.tre -q $d-astraltree-$c-contract.tre -t1  -o $d-astraltree-$c-contract-quartetscore.tre 2> $d-astraltree-$c-contract-quartetscore.log &
	done;
	java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i $d-genetrees.tre -q $d-astraltree.tre -o $d-astraltree-quartetscore.tre -t1 2> $d-astraltree.quartetscore.log &
done

java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i intron-indel-genetrees.tre -q intron-indel-astraltree.tre -o intron-indel-astraltree-polytometest.tre -t10 2> intron-indel-astraltree.polytometest.log &
java -jar ~/workspace/ASTRAL/Astral/astral.5.6.1.jar -i intron-nt-genetrees.tre -q intron-nt-astraltree.tre -o intron-nt-astraltree-polytometest.tre -t10 2> intron-nt-astraltree.polytometest.log &


################# Cleanup logs
sed -i '/Warning:/d' *.log    # astral.5.6.1 adds a spurious warning that should be removed
...
################### RF distance
for x in `cat allastraltrees.txt`; do for y in `cat allastraltrees.txt`; do echo -n $x $y" "; compareTrees.missingBranch $x $y; echo; done; done |tee RF.stats.txt
...
compareTrees genetrees/intron-indel-genetrees.tre genetrees/intron-nt-genetrees.tre 1>/dev/null  2> RF.stat
